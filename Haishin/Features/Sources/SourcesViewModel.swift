...
final class SourcesViewModel {
    ...
    func installGoGoAnimeSource() async {
        ...
        let possiblePaths = [
            "/Users/a616047/Repositories/Private/Haishin/examples/private/gogoanime-source.js",
            NSHomeDirectory() + "/Repositories/Private/Haishin/examples/private/gogoanime-source.js"
        ]
    ...
    /// Installs the GoGoAnime source from the examples directory.
    /// This is only available in debug builds for testing purposes.
    func installHiAnimeSource() async {
        isLoading = true
        defer { isLoading = false }
        ...
        // In development, we can use the known path from the repository
        let possiblePaths = [
            "/Users/a616047/Repositories/Private/Haishin/examples/private/hianimes-source.js",
            NSHomeDirectory() + "/Repositories/Private/Haishin/examples/private/hianimes-source.js"
        ]
